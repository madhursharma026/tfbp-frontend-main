            ...
            <div className="container">
                <div class="row py-5 px-3">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-8">
                        <div class="d-flex" style={{ float: "right", alignItems: "center" }}>
                            <Link to="/#/" class="btn btn-primary me-3">Add Locations</Link>
                            <Link to="/#/" class="btn btn-primary">Add Doctors</Link>
                        </div>
