...
class AutoCompleteService extends HttpService {
  ...
  // filterTFCaseStatus = async ({ leadCondition, treatingCondition, treatingDoneCondition, settlementCondition, open_close, accounting }) => {
  //   const { data } = await this.client.get(
  //     `FilterTFCaseStatus/?tf_case_status=${leadCondition}${treatingCondition}${treatingDoneCondition}${settlementCondition}&open_close=${open_close}&accounting=${accounting}`
  //   );
  //   return data;
  // };
}
